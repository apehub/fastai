...
- Helps keep specs, code, and markdown documentation aligned
- Detects stale AI context and outdated project guidance
- Supports long-term AI collaboration instead of one-time setup

## Why it exists

Most repositories are not designed for sustained AI-assisted development.
...
It is a scaffolding and infrastructure maintenance tool for AI projects.
